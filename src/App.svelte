    ...
    <div class="intro">
        <ul class="intro-list">
            ...
            <li>
                ...
                areas of software engineering, such as software development.
            </li>
            <li>
                In my free time, I usually cycle between playing my Switch
                (currently struggling at Slay the Spire), reading, and scouring
                cafés in the city.
            </li>
        </ul>
    </div>
